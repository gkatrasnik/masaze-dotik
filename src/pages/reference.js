...
const Reference = props => (
  <Layout>
    ...
    <div className="flex flex-wrap-reverse justify-center md:flex-nowrap py-4 md:py-2 px-4 m-2 ">
    ...
    <div className="flex flex-wrap justify-center md:flex-nowrap py-4 md:py-2 px-4 m-2 ">
      <StaticImage
